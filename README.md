...
https://julietchinenyeduru-university-data-pipeline-dashboard-gqwqd2.streamlit.app/

 Data generated

10 faculties

51 departments (Engineering, Science, Management Sciences, Social Sciences, Arts, Law, Education, Agriculture, Environmental Sciences, Health Sciences)
...
Generate — synthetic data creation across all entities (`generate_data.py`)

Extract — load all CSVs into Spark DataFrames

Transform/Join — join students, staff, departments, faculties, courses, and enrollments
